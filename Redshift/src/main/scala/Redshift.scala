...
object Redshift {
  def main(args: Array[String]): Unit = {
    ...
    spark.sparkContext.hadoopConfiguration.set("fs.s3a.secret.key","xxxxxxx")
    spark.sparkContext.hadoopConfiguration.set("fs.s3a.impl","org.apache.hadoop.fs.s3a.S3AFileSystem")

    val jdbcURL = "jdbc:redshift://soumith.cau6uibyjdl8.us-west-2.redshift.amazonaws.com:5439/soumith?user=soumith&password=xxx"
